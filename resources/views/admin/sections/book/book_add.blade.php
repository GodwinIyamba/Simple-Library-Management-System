    ...
    <div class="content">
        ...
        <div class="block block-rounded">
            <div class="block-content block-content-full">
                <form action="{{ route('admin.store_book') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row push">
                        <div class="col-6 col-xl-6">
                            <div class="mb-2">
                                <label class="form-label" for="example-text-input">Title</label>
                                <input type="text" class="form-control @error('title') is-invalid @enderror" id="example-text-input" name="title" placeholder="A Song of Ice and Fire" :value="old('title)">
                                @error('title')
                            ...
                            <div class="mb-2">
                                ...
                                <textarea class="form-control" id="example-textarea-input" name="description" rows="5" placeholder="When the days had grown dark and Ivar seeked a new challenge he looked across the..."></textarea>
                                @error('description')
                                <span class="mt-2" style="color: #dc2626;">
                                {{ $message }}
                            </span>
                            ...
                            <div class="mb-2">
                                ...
                                <input type="text" class="form-control @error('edition') is-invalid @enderror" id="example-text-input" name="edition" placeholder="Original" :value="old('edition)">
                                @error('edition')
                                <span class="mt-2" style="color: #dc2626;">
                                {{ $message }}
                            </span>
                        ...
                        <div class="col-6 col-xl-6">
                            <div class="mb-2">
                                ...
                                <input type="text" class="form-control @error('isbn') is-invalid @enderror" id="example-text-input" name="isbn" placeholder=" 978-1-4357-0132-8" :value="old('isbn)">
                                @error('isbn')
                                <span class="mt-2" style="color: #dc2626;">
                                {{ $message }}
                            </span>
                            ...
                            <div class="mb-4">
                                ...
                                <select class="form-select" id="example-select" name="author_id">
                                    <option selected disabled>Open to select author</option>
                            ...
                            <div class="mb-4">
                                ...
                                <select class="form-select" id="example-select" name="category_id">
                                    <option selected disabled>Open to select category</option>
