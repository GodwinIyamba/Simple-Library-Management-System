                        ...
                        @foreach($categories as $category)
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="btn-group">
                                        <a href="{{ route('admin.edit_category',$category) }}" class="btn btn-sm btn-alt-secondary">
                                            <i class="fa fa-fw fa-pencil-alt"></i>
                                        </a>
                                        <a href="{{ route('admin.delete_category', $category) }}" class="btn btn-sm btn-alt-secondary">
